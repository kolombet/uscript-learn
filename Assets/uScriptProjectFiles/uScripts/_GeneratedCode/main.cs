...
public class main : uScriptLogic
{
   ...
   //local nodes
   System.Single local_2_System_Single = (float) 0.1;
   ...
   void Relay_In_1()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("4dff5ad2-0219-4b70-8865-588257d26562", "Control_GameObject__Move_", Relay_In_1)) return; 
         {
            ...
            {
               logic_uScriptAct_ControlGameObjectMove_Speed_1 = local_2_System_Single;
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript main.uscript at Control GameObject (Move).  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_5()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         ...
         local_2_System_Single = logic_uScriptAct_SetFloat_Target_5;
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript main.uscript at Set Float.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_6()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         ...
         local_2_System_Single = logic_uScriptAct_SetFloat_Target_6;
   ...
   void Relay_In_9()
   {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript main.uscript at Compare GameObjects.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   {
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "main.uscript:2", local_2_System_Single);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "e87d952f-3c04-497e-8036-92fed6bb38ee", local_2_System_Single);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "main.uscript:4", local_4_UnityEngine_GameObject);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "main.uscript:8", local_8_UnityEngine_GameObject);

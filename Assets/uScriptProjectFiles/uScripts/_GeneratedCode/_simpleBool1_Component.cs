...
[AddComponentMenu("uScript/Graphs/_simpleBool1")]
public class _simpleBool1_Component : uScriptCode
{
   #pragma warning disable 414
   public _simpleBool1 ExposedVariables = new _simpleBool1( ); 
      ...
      {
         {
            ...
            gameObject = GameObject.Find( "BooleanTest" ); 
